...
// Need to include timers library on vanilla FreeRTOS
//#include <timers.h>
...
// Settings
static const TickType_t LedInactive_Delay = 5000 / portTICK_PERIOD_MS;
...
void setup() {
  ...
  one_shot_timer = xTimerCreate(
                      ...
                      LedInactive_Delay,            // Period of timer (in ticks)
                      pdFALSE,              // Auto-reload
                      (void *)0,            // Timer ID
